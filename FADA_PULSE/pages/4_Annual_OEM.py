...
st.set_page_config(page_title="Annual & OEM Data — FADA Pulse", page_icon="🗓️", layout="wide")
st.title("🗓️ Annual & OEM data")

annual_tab, oem_tab = st.tabs(["Annual (FY)", "OEM (manufacturer)"])
